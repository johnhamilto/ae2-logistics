...
Status as of v0.30.0 (2026-07-31). DESIGN.md holds the full rationale; this file tracks
...
1. Block stragglers polish (Pattern Workbench, Guarded Provider, Job Scheduler,
   wireless pair, remaining items, Subnet Link), then the ME Storage Janitor and
   Trace Panels feature builds.
