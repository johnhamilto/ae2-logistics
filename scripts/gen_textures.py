...
# Storage bus input cards (F12): shared card frame, amber "seeded box" glyph for
# Conform, cyan "1" for Stack Limiter.
CONFORM_CARD_PAL = dict(CARD)
CONFORM_CARD_PAL["a"] = (230, 164, 44, 255)   # gate amber
...
LIMITER_CARD_PAL = dict(CARD)
LIMITER_CARD_PAL["c"] = (92, 226, 255, 255)   # indicator cyan
...
write_png(OUT / "item" / "conform_card.png", CONFORM_CARD_TEX, CONFORM_CARD_PAL)
write_png(OUT / "item" / "stack_limiter_card.png", LIMITER_CARD_TEX, LIMITER_CARD_PAL)

# Gated Storage Bus face: house steel frame, amber portcullis over the inset.
GATE_FACE_PAL = dict(STEEL)
GATE_FACE_PAL["a"] = (230, 164, 44, 255)
...
write_png(OUT / "part" / "gated_storage_bus.png", GATED_BUS_FACE, GATE_FACE_PAL)


# Pattern Import Card: card frame, blue blank-pattern grid glyph.
PATTERN_CARD_PAL = dict(CARD)
PATTERN_CARD_PAL["b"] = (94, 168, 255, 255)   # blank-pattern blue

PATTERN_IMPORT_CARD_TEX = """
................
...OOOOOOOOOO...
...OFFFFFFFSO...
...OFFFFFFFSO...
...
# Query Card: card frame, cyan query-glyph (a "?" built from indicator cyan).
QUERY_CARD_PAL = dict(CARD)
QUERY_CARD_PAL["c"] = (92, 226, 255, 255)
...
write_png(OUT / "item" / "query_card.png", QUERY_CARD_TEX, QUERY_CARD_PAL)
