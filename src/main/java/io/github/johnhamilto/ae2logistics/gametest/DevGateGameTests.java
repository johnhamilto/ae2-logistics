...
public class DevGateGameTests {
    ...
    static void register() {
        LogisticsTestInstance.add("devGatedDevicesAvailableInDev", "empty5", DevGateGameTests::devGatedDevicesAvailableInDev);
    }
     ...
     */
    public static void devGatedDevicesAvailableInDev(GameTestHelper helper) {
        ...
        helper.assertTrue(recipes.byKey(net.minecraft.resources.ResourceKey.create(
                ...
                AE2Logistics.id("storage_janitor"))).isPresent(),
                "storage_janitor recipe must be loaded in dev");
        helper.assertTrue(recipes.byKey(net.minecraft.resources.ResourceKey.create(
                net.minecraft.core.registries.Registries.RECIPE,
                AE2Logistics.id("trace_panel"))).isPresent(),
