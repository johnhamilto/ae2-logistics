    ...
    public static void onRightClickBlock(PlayerInteractEvent.RightClickBlock event) {
        ...
        if (held.is(AE2Logistics.PATTERN_IMPORT_CARD.get())) {
            ...
            if (installedOnPart(part)) {
                player.sendOverlayMessage(Component.literal("Pattern Import Card already installed"));
                return;
            }
            held.shrink(1);
            installOnPart(part);
            player.sendOverlayMessage(Component.literal("Pattern Import Card installed"));
            ...
            player.sendOverlayMessage(Component.literal("Pattern Import Card removed"));
        }
    }
}
